...
function Joker.LoadSettings()
    ...
    table.insert(panelOptions, {
      type = "description",
      text = L.Joker_Intro_Status_Prefix .. " " .. Joker.Colorize(Joker.formatNumber(Joker.savedVariables.CountSeenJokesTotal)) .. " " .. L.Joker_Intro_Status_Of .. " " .. Joker.Colorize(Joker.formatNumber(Joker.savedVariables.CountJokesTotal)) .. " " .. L.Joker_Intro_Status_Suffix,
      width = "full",	--or "half" (optional)
    })

    table.insert(panelOptions, {
      type = "submenu",
      name = L.Joker_Options_Title,
      tooltip	= "",
      controls		= {
        [1] = {
            type			  = "checkbox",
        ...
        [2] = {
          ...
          tooltip			= optionIndent .. L.Joker_Options_PeriodicFrequency_Tip,
          getFunc			= function() return true end,
          setFunc			= function(value) return true end,
          width			  = "full",
          default			= true,
