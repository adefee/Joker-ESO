...
Joker = {
  ...
  version                   = "3.0.1",                                    -- Joker internal versioning: Release.Major.Minor
  versionESO                = 300010,                                     -- ESO internal versioning: [Release*10][Major*10][Minor*10]
  forceNewVariables         = 3,                                          -- Incrementing forces a new variable set (so we lose our savedVars)
...
function Joker.Activated(e)
  ...
  if Joker.savedVariables and Joker.savedVariables.FirstLoad then
