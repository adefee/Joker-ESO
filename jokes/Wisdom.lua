...
JokerData.Wisdom = {
  ...
  "For the first 8 minutes of your life, the sunight around you is older than you are.",
  ...
  "They put music from the 50s and 60s in medicne commercials to appeal to the older generations of today - meaning sometime in the future, 'Despactio' may end up playing on a commercial for laxatives.",
  ...
  "Maybe dogs bring home sticks because that's what was bred into them over millenia of humands needing wood for fires.",
  "The Jedi must go through a tone of robes because they're always stripping them off before combat and just leaving them there.",
  ...
  "You're tongue's ability to detect hair is underrated.",
  ...
  "People saying not to talk to them 'before their morning coffee' are bsaically admitting to being unpleasant when not under the influence of drugs.",
  ...
  "Peple shake with their right hand as a sign of trust, with both participants immobilising their dominant hand. This makes left-handed people the most dangerous to shake hands with.",
