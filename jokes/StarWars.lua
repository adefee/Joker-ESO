...
JokerData.StarWars = {
  ...
  "Out of Context Star Wars Quotes: 'She may not look like much, but she's got it where it counts, kid.'",
  "Out of Context Star Wars Quotes: 'Curse my metal body, I wasn't fast enough!'",
  "Out of Context Star Wars Quotes: 'Look at the size of that thing!'",
  "Out of Context Star Wars Quotes: 'Sorry about the mess...'",
  "Out of Context Star Wars Quotes: 'You came in that thing? You're braver than I thought.'",
  "Out of Context Star Wars Quotes: 'Aren't you a little short for a stormtrooper?'",
  "Out of Context Star Wars Quotes: 'You've got something jammed in here real good.'",
  "Out of Context Star Wars Quotes: 'That's okay, I'd like to keep it on manual control for a while.'",
  "Out of Context Star Wars Quotes: 'Hurry up, golden-rod...'",
  "Out of Context Star Wars Quotes: 'I must've hit it pretty close to the mark to get her all riled up like that, huh kid?'",
  "Out of Context Star Wars Quotes: 'Possible he came in through the south entrance.'",
  "Out of Context Star Wars Quotes: 'And I thought they smelled bad on the outside!'",
  "Out of Context Star Wars Quotes: 'Control, control! You must learn control!'",
  "Out of Context Star Wars Quotes: 'Put that thing away before you get us all killed!'",
  "Out of Context Star Wars Quotes: 'Luke, at that speed do you think you'll be able to pull out in time?'",
  "Out of Context Star Wars Quotes: 'Get in there you big furry oaf, I don't care what you smell!'",
